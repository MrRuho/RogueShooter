...
public class WeaponDefinitionEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.LabelField("Range: Weapon basic max Range (No upgrades)", EditorStyles.boldLabel);
        EditorGUILayout.PropertyField(maxShootRange);
        EditorGUILayout.Space(5);

        EditorGUILayout.LabelField("Bonus when the target is not behind cover", EditorStyles.boldLabel);
        EditorGUILayout.PropertyField(noCoverDamageBonus);
        EditorGUILayout.Space(5);

        EditorGUILayout.LabelField("Base damage", EditorStyles.boldLabel);
        ...
        EditorGUILayout.LabelField("Advanced accuracy: per-band tunables", EditorStyles.boldLabel);
